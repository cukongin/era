        ...
        <div class="flex items-center gap-4">
            ...
            <div class="flex items-center gap-3 pl-2">
                ...
                <div class="flex flex-col">
                    <span class="text-sm font-bold text-slate-900 dark:text-white leading-none"><?php echo e(auth()->user()->name); ?></span>
        ...
        <div class="max-w-7xl mx-auto flex flex-col gap-8 pt-6">
            ...
            <div class="flex flex-col md:flex-row md:items-end justify-between gap-6">
                <div class="flex flex-col gap-2">
                    <h2 class="text-3xl font-bold text-slate-900 dark:text-white tracking-tight">Selamat Datang, <?php echo e(auth()->user()->name); ?> 👋</h2>
                ...
                <div class="flex items-center gap-2">
                    ...
                    <span class="text-slate-400 text-sm font-medium"><?php echo e(date('d F Y')); ?></span>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <div class="bg-white dark:bg-[#1a2e22] p-6 rounded-2xl shadow-sm border border-slate-100 dark:border-slate-800 relative overflow-hidden group hover:border-primary/30 transition-colors">
                    ...
                    <div class="flex flex-col gap-1 relative z-10">
                        ...
                        <h3 class="text-3xl font-bold text-slate-900 dark:text-white"><?php echo e($stats['total_siswa']); ?></h3>
                        <div class="flex gap-3 mt-2 text-xs font-medium">
                            <span class="text-primary bg-primary/5 px-2 py-0.5 rounded-md border border-primary/10">MI: <?php echo e($stats['siswa_mi']); ?></span>
                            <span class="text-primary bg-primary/5 px-2 py-0.5 rounded-md border border-primary/10">MTs: <?php echo e($stats['siswa_mts']); ?></span>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white dark:bg-[#1a2e22] p-6 rounded-2xl shadow-sm border border-slate-100 dark:border-slate-800 relative overflow-hidden group hover:border-primary/30 transition-colors">
                    ...
                    <div class="flex flex-col gap-1 relative z-10">
                        ...
                        <h3 class="text-3xl font-bold text-slate-900 dark:text-white"><?php echo e($stats['total_guru']); ?></h3>
                        <div class="flex gap-3 mt-2 text-xs font-medium">
                            <span class="text-slate-600 bg-slate-100 px-2 py-0.5 rounded-md"><?php echo e($stats['total_kelas']); ?> Kelas Wali</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-gradient-to-br from-primary to-green-700 text-white p-6 rounded-2xl shadow-lg shadow-green-900/20 relative overflow-hidden col-span-1 md:col-span-2">
                    ...
                    <div class="flex justify-between items-start relative z-10">
                        <div class="flex flex-col gap-1">
                            ...
                            <h3 class="text-3xl font-bold"><?php echo e($activeYear ? $activeYear->nama : 'Belum Ada'); ?></h3>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                <div class="flex flex-col gap-5">
                     ...
                     <div class="bg-white dark:bg-[#1a2e22] rounded-2xl p-8 border border-slate-100 dark:border-slate-800 shadow-sm flex flex-col gap-8">
                        ...
                        <div class="relative">
                            ...
                            <!-- Active Line -->
                            <div class="absolute top-1/2 left-0 h-1 bg-primary -z-10 -translate-y-1/2 rounded-full transition-all duration-1000" style="width: <?php echo e(($activeCawu - 1) * 50); ?>%"></div>

                            <div class="flex justify-between w-full">
                                <?php $__currentLoopData = $cawuLabels; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php $step = $index + 1; ?>
                                    <div class="flex flex-col items-center gap-3 bg-white dark:bg-[#1a2e22] px-2 relative z-10">
                                        <?php if($step < $activeCawu): ?>
                                        ...
                                        <?php elseif($step == $activeCawu): ?>
                                            <div class="size-10 rounded-full bg-white border-2 border-primary text-primary flex items-center justify-center shadow-lg ring-4 ring-primary/10 animate-pulse-slow">
                                                <span class="text-sm font-bold"><?php echo e($step); ?></span>
                                            </div>
                                        <?php else: ?>
                                        ...
                                        <?php endif; ?>
                                        <span class="text-xs font-bold uppercase tracking-wider <?php echo e($step == $activeCawu ? 'text-primary' : 'text-slate-400'); ?>"><?php echo e($label); ?></span>
                                    </div>
                        ...
                        <div class="grid grid-cols-2 gap-6">
                            <div class="p-5 bg-slate-50 dark:bg-slate-800/50 rounded-xl border border-slate-100 dark:border-slate-800 flex flex-col items-center text-center">
                                ...
                                <p class="text-2xl font-bold text-slate-900 dark:text-white">
                                    <?php echo e($miStats['finalized_classes']); ?> <span class="text-slate-400 text-sm font-normal">/ <?php echo e($miStats['total_classes']); ?></span>
                                </p>
                            </div>
                            <div class="p-5 rounded-xl border flex flex-col items-center text-center <?php echo e(is_null($miStats['days_left']) ? 'bg-slate-50 border-slate-100' : ($miStats['days_left'] < 7 ? 'bg-red-50 border-red-100 text-red-700' : 'bg-primary/5 border-primary/10 text-primary')); ?>">
                                <span class="text-xs font-bold uppercase tracking-wide mb-1 <?php echo e(is_null($miStats['days_left']) ? 'text-slate-500' : ($miStats['days_left'] < 7 ? 'text-red-600' : 'text-primary')); ?>">Deadline Penilaian</span>
                                <?php if(is_null($miStats['days_left'])): ?>
                                     <p class="text-sm font-bold text-slate-400 mt-1">Belum Diset</p>
                                 <?php else: ?>
                                     <p class="text-2xl font-bold"><?php echo e($miStats['days_left']); ?> <span class="text-xs font-normal opacity-80">Hari Lagi</span></p>
                                 <?php endif; ?>
                            </div>
                        </div>
                     </div>
                    ...
                    <h3 class="text-lg font-bold text-slate-900 dark:text-white flex items-center gap-3">
                     ...
                     <div class="bg-white dark:bg-[#1a2e22] rounded-2xl p-8 border border-slate-100 dark:border-slate-800 shadow-sm flex flex-col justify-between h-full gap-6">
                        <div class="flex flex-col gap-4">
                             <!-- Semesters -->
                            <div class="relative overflow-hidden rounded-xl border <?php echo e($mtsStats['active_semester'] == 1 ? 'border-primary shadow-lg shadow-primary/5 bg-primary/5' : 'border-slate-200 opacity-60'); ?> p-5 flex items-center justify-between transition-all">
                                <div class="flex items-center gap-4">
                                    <div class="size-12 rounded-full <?php echo e($mtsStats['active_semester'] == 1 ? 'bg-primary text-white' : 'bg-slate-100 text-slate-400'); ?> flex items-center justify-center font-bold text-lg">1</div>
                                    <div>
                                        <p class="font-bold text-slate-900 dark:text-white text-lg">Semester Ganjil</p>
                                        <p class="text-sm text-slate-500"><?php echo e($mtsStats['active_semester'] == 1 ? 'Status: Sedang Berjalan' : ($mtsStats['active_semester'] > 1 ? 'Status: Selesai' : 'Status: Belum Mulai')); ?></p>
                                    </div>
                                </div>
                                <?php if($mtsStats['active_semester'] == 1): ?>
                                <div class="px-3 py-1 bg-white text-primary rounded-lg text-xs font-bold border border-primary/20 shadow-sm">AKTIF</div>
                                <?php endif; ?>
                            </div>

                            <div class="relative overflow-hidden rounded-xl border <?php echo e($mtsStats['active_semester'] == 2 ? 'border-primary shadow-lg shadow-primary/5 bg-primary/5' : 'border-slate-200 opacity-60'); ?> p-5 flex items-center justify-between transition-all">
                                <div class="flex items-center gap-4">
                                    <div class="size-12 rounded-full <?php echo e($mtsStats['active_semester'] == 2 ? 'bg-primary text-white' : 'bg-slate-100 text-slate-400'); ?> flex items-center justify-center font-bold text-lg">2</div>
                                    <div>
                                        <p class="font-bold text-slate-900 dark:text-white text-lg">Semester Genap</p>
                                        <p class="text-sm text-slate-500"><?php echo e($mtsStats['active_semester'] == 2 ? 'Status: Sedang Berjalan' : 'Status: Belum Mulai'); ?></p>
                                    </div>
                                </div>
                                 <?php if($mtsStats['active_semester'] == 2): ?>
                                <div class="px-3 py-1 bg-white text-primary rounded-lg text-xs font-bold border border-primary/20 shadow-sm">AKTIF</div>
                                <?php endif; ?>
                            </div>
                        </div>
                         ...
                         <div class="mt-auto p-4 bg-slate-50 dark:bg-slate-800/50 rounded-xl text-center border-t border-slate-100 dark:border-slate-800">
                            ...
                            <p class="text-xl font-bold text-slate-900 dark:text-white">
                                 <?php if($mtsStats['deadline']): ?>
                                    <?php echo e(\Carbon\Carbon::parse($mtsStats['deadline'])->translatedFormat('d F Y')); ?>
             ...
             <div class="flex flex-col gap-4 pb-8" x-data="{
                ...
                // Bulk Data
                bulkClasses: <?php echo e(json_encode($ongoingClasses)); ?>,
                    ...
                    <div class="overflow-y-auto custom-scrollbar">
                        <table class="w-full text-left text-sm whitespace-nowrap">
                            ...
                            <tbody class="divide-y divide-slate-100 dark:divide-slate-800">
                                <?php $__empty_1 = true; $__currentLoopData = $ongoingClasses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kelas): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr class="hover:bg-slate-50 dark:hover:bg-slate-800/30 transition-colors">
                                    <td class="px-6 py-4 font-bold text-slate-900 dark:text-white">
                                        <?php echo e($kelas['nama_kelas']); ?>

                                        <span class="ml-2 px-2 py-0.5 rounded bg-slate-100 text-slate-500 text-[10px] font-normal"><?php echo e($kelas['jenjang']); ?></span>
                                    </td>
                                    <td class="px-6 py-4 text-slate-600 dark:text-slate-300">
                                        <?php echo e($kelas['wali_kelas']); ?>

                                    </td>
                                    <td class="px-6 py-4 text-center">
                                         <?php if($kelas['deadline_diff'] <= 7 && $kelas['deadline_diff'] >= 0): ?>
                                            <span class="text-orange-600 font-bold text-xs"><?php echo e($kelas['deadline_diff']); ?> Hari Lagi</span>
                                         <?php elseif($kelas['deadline_diff'] < 0): ?>
                                    ...
                                    <td class="px-6 py-4 text-center flex items-center justify-center gap-2">
                                        <a href="<?php echo e(route('classes.show', $kelas['id'])); ?>" class="size-8 rounded-lg bg-slate-100 hover:bg-primary hover:text-white flex items-center justify-center transition-colors" title="Lihat Kelas">
                                            <span class="material-symbols-outlined text-[16px]">visibility</span>
                                        </a>

                                        <?php if($kelas['wali_id']): ?>
                                        <button @click="showReminderModal = true; selectedWaliId = '<?php echo e($kelas['wali_id']); ?>'; selectedKelasName = '<?php echo e($kelas['nama_kelas']); ?>'"
             ...
             <div class="flex flex-col gap-4 pb-8" x-data="{ showReminderModal: false, selectedWaliId: '', selectedKelasName: '', reminderMessage: '', messageType: 'warning' }">
                ...
                <div x-show="showReminderModal" style="display: none;" class="fixed inset-0 z-50 flex items-center justify-center bg-slate-900/50 backdrop-blur-sm"
                    ...
                    <div class="bg-white dark:bg-[#1a2e22] rounded-2xl shadow-xl w-full max-w-md p-6 m-4"
                        ...
                        <form action="<?php echo e(route('dashboard.remind-wali')); ?>" method="POST">
                            <?php echo csrf_field(); ?>
                ...
                <div x-show="showBulkModal" style="display: none;" class="fixed inset-0 z-50 flex items-center justify-center bg-slate-900/50 backdrop-blur-sm"
                    ...
                    <div class="bg-white dark:bg-[#1a2e22] rounded-2xl shadow-xl w-full max-w-2xl p-6 m-4 max-h-[90vh] flex flex-col"
                        ...
                        <form action="<?php echo e(route('dashboard.remind-bulk')); ?>" method="POST" class="flex-1 flex flex-col overflow-hidden">
                            <?php echo csrf_field(); ?>
                            <input type="hidden" name="type" :value="messageType">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\XAMPP\htdocs\erapor\resources\views/dashboard.blade.php ENDPATH**/ ?>