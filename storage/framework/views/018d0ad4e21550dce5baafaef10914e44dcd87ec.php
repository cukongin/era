            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <div class="bg-white dark:bg-[#1a2e22] p-6 rounded-2xl shadow-sm border border-slate-100 dark:border-slate-800 relative overflow-hidden group">
                    ...
                    <div class="flex flex-col gap-1 relative z-10">
                        ...
                        <div class="flex gap-3 mt-2 text-xs font-medium">
                            <span class="text-blue-600 bg-blue-50 px-2 py-0.5 rounded-md">MI: <?php echo e($stats['siswa_mi']); ?></span>
                            <span class="text-indigo-600 bg-indigo-50 px-2 py-0.5 rounded-md">MTs: <?php echo e($stats['siswa_mts']); ?></span>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white dark:bg-[#1a2e22] p-6 rounded-2xl shadow-sm border border-slate-100 dark:border-slate-800 relative overflow-hidden group">
                    ...
                    <div class="flex flex-col gap-1 relative z-10">
                        ...
                        <div class="flex gap-3 mt-2 text-xs font-medium">
                            <span class="text-orange-600 bg-orange-50 px-2 py-0.5 rounded-md"><?php echo e($stats['total_kelas']); ?> Kelas Wali</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="flex flex-col gap-4">
                     ...
                     <div class="bg-white dark:bg-[#1a2e22] rounded-2xl p-6 border border-slate-100 dark:border-slate-800 shadow-sm flex flex-col gap-6">
                        ...
                        <div class="relative flex justify-between items-center my-4">
                            ...
                            <div class="absolute top-1/2 left-0 h-1 bg-teal-500 -z-10 -translate-y-1/2 rounded-full transition-all duration-1000" style="width: <?php echo e(($activeCawu - 1) * 50); ?>%"></div> <!-- Hack: 0%, 50%, 100% -->
                                ...
                                <div class="flex flex-col items-center gap-2 bg-white dark:bg-[#1a2e22] px-2">
                                    ...
                                    <?php elseif($step == $activeCawu): ?>
                                        <div class="size-8 rounded-full bg-white border-2 border-teal-500 text-teal-600 flex items-center justify-center shadow-md ring-4 ring-teal-50">
                                            <span class="text-xs font-bold"><?php echo e($step); ?></span>
                                        </div>
                                    <?php else: ?>
                                    ...
                                    <?php endif; ?>
                                    <span class="text-xs font-bold <?php echo e($step == $activeCawu ? 'text-teal-600' : 'text-slate-400'); ?>"><?php echo e($label); ?></span>
                                </div>
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            ...
                            <div class="p-4 bg-orange-50 dark:bg-orange-900/10 rounded-xl border border-orange-100 dark:border-orange-900/30">
                                ...
                                <?php if(is_null($miStats['days_left'])): ?>
                                 ...
                                 <?php else: ?>
                                     <p class="text-lg font-bold text-slate-900 dark:text-white"><?php echo e($miStats['days_left']); ?> <span class="text-xs font-normal text-slate-500">Hari Lagi</span></p>
                                 <?php endif; ?>
                            </div>
                        </div>
                     </div>
                ...
                <div class="flex flex-col gap-4">
                    <h3 class="text-lg font-bold text-slate-900 dark:text-white flex items-center gap-2">
                     ...
                     <div class="bg-white dark:bg-[#1a2e22] rounded-2xl p-6 border border-slate-100 dark:border-slate-800 shadow-sm flex flex-col justify-between h-full">
                        <div class="flex flex-col gap-4">
                             <!-- Semesters -->
                            <div class="relative overflow-hidden rounded-xl border <?php echo e($mtsStats['active_semester'] == 1 ? 'border-indigo-500 shadow-md shadow-indigo-500/10' : 'border-slate-200 opacity-60'); ?> p-4 flex items-center justify-between bg-white dark:bg-[#1a2e22]">
                                <div class="flex items-center gap-3">
                                    <div class="size-10 rounded-full <?php echo e($mtsStats['active_semester'] == 1 ? 'bg-indigo-100 text-indigo-600' : 'bg-slate-100 text-slate-400'); ?> flex items-center justify-center font-bold">1</div>
                                    <div>
                                        <p class="font-bold text-slate-900 dark:text-white">Semester Ganjil</p>
                                        <p class="text-xs text-slate-500"><?php echo e($mtsStats['active_semester'] == 1 ? 'Sedang Berjalan' : ($mtsStats['active_semester'] > 1 ? 'Selesai' : 'Belum Mulai')); ?></p>
                                    </div>
                                </div>
                            ...
                            <div class="relative overflow-hidden rounded-xl border <?php echo e($mtsStats['active_semester'] == 2 ? 'border-indigo-500 shadow-md shadow-indigo-500/10' : 'border-slate-200 opacity-60'); ?> p-4 flex items-center justify-between bg-white dark:bg-[#1a2e22]">
                                <div class="flex items-center gap-3">
                                    <div class="size-10 rounded-full <?php echo e($mtsStats['active_semester'] == 2 ? 'bg-indigo-100 text-indigo-600' : 'bg-slate-100 text-slate-400'); ?> flex items-center justify-center font-bold">2</div>
                                    <div>
                                        <p class="font-bold text-slate-900 dark:text-white">Semester Genap</p>
                                        <p class="text-xs text-slate-500"><?php echo e($mtsStats['active_semester'] == 2 ? 'Sedang Berjalan' : 'Belum Mulai'); ?></p>
                                    </div>
                                </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u838039955/domains/rm.alhasany.or.id/public_html/resources/views/dashboard.blade.php ENDPATH**/ ?>