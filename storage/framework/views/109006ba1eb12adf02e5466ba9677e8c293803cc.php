...
<head>
    ...
    <title>Rapor <?php echo e($student->nama_lengkap); ?> - <?php echo e($class->nama_kelas); ?></title>
    ...
    <link href="<?php echo e(asset('css/fonts.css')); ?>" rel="stylesheet"/> <!-- LPMQ Font -->
...
<div class="print-wrapper flex w-full justify-center p-6 sm:p-10">
    <?php echo $__env->make('reports.partials.rapor_content', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
</div>

</body>
</html>
<?php /**PATH /home/u838039955/domains/rm.alhasany.or.id/public_html/resources/views/reports/rapor_print.blade.php ENDPATH**/ ?>