                    ...
                    <tbody class="divide-y divide-slate-100 dark:divide-slate-800">
                        ...
                        <tr class="hover:bg-slate-50 dark:hover:bg-slate-800/30">
                            ...
                            <td class="px-4 py-2 bg-blue-50/30">
                                <input type="number" name="absensi[<?php echo e($ak->id_siswa); ?>][sakit]" value="<?php echo e($absensi->sakit ?? 0); ?>" min="0" class="w-full text-center font-bold text-primary rounded-lg border-slate-300 dark:bg-slate-800 dark:border-slate-700 focus:ring-primary focus:border-primary abs-input" data-target="total-<?php echo e($ak->id); ?>">
                            </td>
                            <td class="px-4 py-2 bg-amber-50/30">
                                <input type="number" name="absensi[<?php echo e($ak->id_siswa); ?>][izin]" value="<?php echo e($absensi->izin ?? 0); ?>" min="0" class="w-full text-center font-bold text-amber-700 rounded-lg border-slate-300 dark:bg-slate-800 dark:border-slate-700 focus:ring-amber-500 focus:border-amber-500 abs-input" data-target="total-<?php echo e($ak->id); ?>">
                            </td>
                    ...
                    <div class="bg-slate-50 dark:bg-slate-800/50 rounded-lg p-3">
                        ...
                        <div class="grid grid-cols-3 gap-3">
                            <div class="flex flex-col gap-1">
                                ...
                                <input type="number" name="absensi[<?php echo e($ak->id_siswa); ?>][sakit]" value="<?php echo e($absensi->sakit ?? 0); ?>" min="0" class="w-full text-center font-bold text-primary bg-white border border-primary/20 rounded-lg py-2 focus:ring-2 focus:ring-primary focus:border-primary abs-input-mobile" data-target="total-mob-<?php echo e($ak->id); ?>">
                            </div>
                            <div class="flex flex-col gap-1">
                                <label class="text-[10px] font-bold text-amber-600 uppercase text-center">Izin</label>
                                <input type="number" name="absensi[<?php echo e($ak->id_siswa); ?>][izin]" value="<?php echo e($absensi->izin ?? 0); ?>" min="0" class="w-full text-center font-bold text-amber-700 bg-white border border-amber-200 rounded-lg py-2 focus:ring-2 focus:ring-amber-500 focus:border-amber-500 abs-input-mobile" data-target="total-mob-<?php echo e($ak->id); ?>">
                            </div>
                            <div class="flex flex-col gap-1">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\XAMPP\htdocs\erapor\resources\views/wali-kelas/absensi.blade.php ENDPATH**/ ?>