        ...
        <div class="p-8 pb-6">
            ...
            <form action="<?php echo e(route('login.post')); ?>" method="POST" class="flex flex-col gap-4">
                ...
                <div class="flex flex-col gap-1.5">
                    ...
                    <input type="email" name="email" class="w-full rounded-lg border-slate-300 focus:border-primary focus:ring-primary text-sm placeholder-slate-400" placeholder="admin@madrasah.com" value="<?php echo e(old('email')); ?>" required>
                </div>
...
<?php /**PATH /home/u838039955/domains/rm.alhasany.or.id/public_html/resources/views/auth/login.blade.php ENDPATH**/ ?>