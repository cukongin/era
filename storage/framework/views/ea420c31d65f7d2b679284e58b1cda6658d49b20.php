<?php $__env->startSection('title', 'Pilih Kelas - DKN Ijazah'); ?>
...
<div class="flex-1 flex flex-col h-full overflow-hidden">
    ...
    <div class="px-8 py-6 bg-white dark:bg-[#1a2e22] border-b border-slate-200 dark:border-slate-800 flex justify-between items-center">
        ...
        <a href="<?php echo e(route('tu.dashboard')); ?>" class="px-4 py-2 bg-slate-100 hover:bg-slate-200 text-slate-600 rounded-xl font-bold text-sm transition-colors flex items-center gap-2">
        ...
        <div class="max-w-6xl mx-auto">
            ...
            <?php else: ?>
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    <?php $__currentLoopData = $finalClasses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kelas): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="bg-white dark:bg-[#1a2e22] rounded-2xl border border-slate-200 dark:border-slate-700 p-6 shadow-sm hover:shadow-md transition-all group relative overflow-hidden">
                            ...
                            <div class="relative z-10 flex flex-col h-full">
                                <span class="inline-block px-3 py-1 rounded-full bg-primary/10 text-primary text-[10px] font-bold uppercase tracking-wider w-fit mb-3">
                                    <?php echo e($kelas->jenjang->nama_jenjang ?? $kelas->tingkat_kelas); ?>
                                ...
                                <p class="text-sm text-slate-500 mb-6 flex items-center gap-1">
                                    ...
                                    <?php echo e($kelas->wali_kelas ? $kelas->wali_kelas->name : 'Tanpa Wali Kelas'); ?>

                                </p>

                                <div class="mt-auto flex flex-col gap-3">
                                    <a href="<?php echo e(route('tu.dkn.show', $kelas->id)); ?>" class="w-full py-3 bg-primary text-white rounded-xl font-bold text-sm shadow-lg shadow-primary/20 hover:bg-primary/90 hover:shadow-primary/30 transition-all flex items-center justify-center gap-2">
                                        <span class="material-symbols-outlined text-[18px]">edit_note</span> Input Nilai Ijazah
                                    </a>

                                    <a href="<?php echo e(route('tu.dkn.archive', $kelas->id)); ?>" class="w-full py-3 bg-slate-50 text-slate-600 hover:bg-slate-100 hover:text-slate-900 border border-slate-100 rounded-xl font-bold text-sm transition-all flex items-center justify-center gap-2">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\XAMPP\htdocs\erapor\resources\views/tu/dkn-selector.blade.php ENDPATH**/ ?>