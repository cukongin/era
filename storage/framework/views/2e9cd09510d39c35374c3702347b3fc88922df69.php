    ...
    <div class="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
        <div>
            ...
            <p class="text-sm text-slate-500">
                ...
                <br>Kelas: <span class="font-bold text-indigo-600"><?php echo e($kelas->nama_kelas); ?></span>
        ...
        <div class="flex gap-2 items-center">
            <!-- Filter Lengkap -->
            <form action="<?php echo e(route('walikelas.kenaikan.index')); ?>" method="GET" class="flex flex-col md:flex-row gap-2 items-center flex-wrap w-full md:w-auto p-2 md:p-0 bg-slate-50 md:bg-transparent rounded-lg md:rounded-none border md:border-none border-slate-200">
            ...
            <div class="bg-white dark:bg-slate-800 rounded-xl p-4 shadow-sm border border-slate-200 dark:border-slate-700"
                ...
                <div class="flex items-center justify-between pt-3 border-t border-slate-100 dark:border-slate-700 gap-2">
                    ...
                    <?php if((!isset($isLocked) || !$isLocked) && (!$stat->is_locked || auth()->user()->isAdmin())): ?>
                        <button @click="openModal(<?php echo e($studentJson); ?>)" class="p-1.5 rounded-lg bg-indigo-50 text-indigo-600 hover:bg-indigo-100 border border-indigo-200 transition-colors">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\erapor\resources\views/wali-kelas/kenaikan-kelas.blade.php ENDPATH**/ ?>