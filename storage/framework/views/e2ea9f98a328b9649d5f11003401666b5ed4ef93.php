            ...
            <table class="w-full text-left border-collapse">
                ...
                <tbody class="divide-y divide-slate-200 dark:divide-slate-800">
                    ...
                    <tr class="group hover:bg-primary/5 dark:hover:bg-primary/10 transition-colors">
                        ...
                        <td class="py-4 px-4">
                            <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium <?php echo e(optional($student->jenjang)->kode == 'MI' ? 'bg-blue-100 text-blue-800' : 'bg-purple-100 text-purple-800'); ?>">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u838039955/domains/rm.alhasany.or.id/public_html/resources/views/master/students/index.blade.php ENDPATH**/ ?>