...
<head>
    ...
    <title>Cetak Massal Rapor - <?php echo e($class->nama_kelas); ?></title>
    ...
    <div class="max-w-[1200px] mx-auto flex flex-wrap items-center justify-between gap-4">
        <div class="flex items-center gap-3">
            ...
            <div>
                ...
                <p class="text-xs text-gray-500">Kelas <?php echo e($class->nama_kelas); ?> • <?php echo e(count($reports)); ?> Siswa</p>
            </div>
        </div>
...
<div class="print-wrapper w-full">
    <?php $__currentLoopData = $reports; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <div class="page-break flex w-full justify-center p-6 sm:p-10 print:p-0">
            ...
            ?>
            <?php echo $__env->make('reports.partials.rapor_content', $data, \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        </div>
...
<?php /**PATH /home/u838039955/domains/rm.alhasany.or.id/public_html/resources/views/reports/rapor_print_all.blade.php ENDPATH**/ ?>