        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div class="bg-white dark:bg-slate-800 rounded-xl shadow-sm border border-slate-200 dark:border-slate-700 p-6">
                ...
                <div class="space-y-4">
                    ...
                    <a id="btnDlMI" href="{{ route('grade.import.global.template', 'MI') }}" class="block w-full text-center px-4 py-2 border-2 border-dashed border-green-300 rounded-lg hover:bg-green-50 transition-colors font-bold text-green-700">
            ...
            <div class="bg-white dark:bg-slate-800 rounded-xl shadow-sm border border-slate-200 dark:border-slate-700 p-6">
                ...
                <div class="space-y-4">
                    ...
                    <a id="btnDlMTS" href="{{ route('grade.import.global.template', 'MTS') }}" class="block w-full text-center px-4 py-2 border-2 border-dashed border-blue-300 rounded-lg hover:bg-blue-50 transition-colors font-bold text-blue-700">
                        <span class="material-symbols-outlined align-middle mr-2">download</span>
