        ...
        <div class="lg:col-span-1 space-y-6">
            <form action="{{ route('walikelas.katrol.store') }}" method="POST" class="bg-white dark:bg-[#1a2e22] rounded-xl border border-slate-200 dark:border-slate-800 shadow-sm p-6 sticky top-6">
                ...
                <div class="flex flex-col gap-3">
                    <button type="button" @click="applyPreview()" class="w-full bg-blue-600 hover:bg-blue-700 text-white font-bold py-3 px-4 rounded-xl shadow-lg shadow-blue-600/20 transition-all flex justify-center items-center gap-2">
                        <span class="material-symbols-outlined">play_circle</span> Hitung / Preview
                    </button>
                    
                    <div class="flex gap-2">
                        <button type="submit" class="flex-1 bg-green-600 hover:bg-green-700 text-white font-bold py-3 px-4 rounded-xl shadow-lg shadow-green-600/20 transition-all flex justify-center items-center gap-2">
                            ...
                            >
                                ...
                                <td class="p-4 text-center">
                                    <template x-if="isModified">
                                        <span class="inline-flex items-center px-2 py-0.5 rounded text-xs font-bold"
                                              :class="diff > 0 ? 'bg-green-100 text-green-700' : 'bg-red-100 text-red-700'"
                                ...
                                <td class="p-4 text-xs text-slate-500">
                                    ...
                                    <template x-if="hasPreviewed && isModified">
                                        <span class="bg-blue-50 text-blue-600 px-2 py-1 rounded">Preview</span>
                                    </template>
